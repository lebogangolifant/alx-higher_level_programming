#!/usr/bin/python3
"""Module for private attributes with getter and setter methods"""
...
class Rectangle(Base):
    ...
    def update(self, *args, **kwargs):
        """Update the Rectangle instance with the given arguments"""
        if args:
            if len(args) >= 1:
                self.id = args[0]
            if len(args) >= 2:
    ...
    def to_csv_row(self):
        """Return the CSV row representation of a Rectangle instance"""
